function [ planet_object, w_rotation, plotHandle ] = planet3D(planetNum, coords, multiplier)
% planet3D Creates a 3D model of the planet in a figure
%
% PROTOTYPE: 
%   [ planet_object, w_rotation, plotHandle ] = planet3D(planetNum, coords, multiplier)
%
% INPUT:
%   planetNum[1]            Number from 1 to 11, to choose which body to display from the following list:
%                               1  Mercury      
%                               2  Venus       
%                               3  Earth       
%                               4  Mars      
...
%                               10 Sun
%                               11 Moon
%   coords[1]               If specified, centers the sphere at coordinates [ x, y, z ] [km], otherwise in origin
%   multiplier[1]           If specified, multiplies the radius of the planet multiplier times
%
% OUTPUT: 
%   planet_object[1]        Object used to rotate the planet with rotate(planet_object, ...)
%   w_rotation[1]           Rotational speed of planet
% 
% CALLED FUNCTIONS:
%   astroConstants();
%
